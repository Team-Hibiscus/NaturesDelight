...
public class NaturesDelightBlocksAndItems {
   ...
   public static final  Block SHIITAKE_MUSHROOM_COLONY_BLOCK = registerBlock("shiitake_mushroom_colony",
           new MushroomColonyBlock(AbstractBlock.Settings.copy(NSMiscBlocks.SHIITAKE_MUSHROOM), NSMiscBlocks.SHIITAKE_MUSHROOM::asItem));
   ...
   public static Item registerItem(String name, Item item, RegistryKey<ItemGroup> group, Item itemBefore) {
      ...
      if (NatureSpirit.CONFIG.creative_tab) ItemGroupEvents.modifyEntriesEvent(group).register(entries -> entries.addAfter(itemBefore, item1));
